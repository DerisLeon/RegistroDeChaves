...
const baseURLSetores = "http://localhost:8080/setores";

const validationSchema = Yup.object().shape({
  nome: Yup.string()
    .required('Nome é obrigatório')
    .matches(/^[a-zA-ZÀ-úçÇ ]*$/, 'Nome deve conter apenas letras')
    .trim()
  ...
  motivo: Yup.string()
    ...
    .max(20, 'Motivo deve ter no máximo 20 caracteres'),
});
...
const SetoresList = () => {
  ...
  const requisitarChave = async (id) => {
    try {
      ...
      const solicitante = { nome, matricula, motivo, tipo: tipoSolicitante };
